...
productosDisponibles.forEach((producto) => {
    ...
    cardClonada.querySelector('.card-text').innerText = producto.precio

    cardClonada.querySelector('.card-img-top').setAttribute('src', producto.imagen)

    cardClonada.querySelector('.botonCarrito').addEventListener('click', () => avisar())
